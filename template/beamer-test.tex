...
% NOTE: minted is included in dynamic-slides.tex
...
\begin{document}\begin{minipage}{15cm}\myInitialize\typeout{HERESTARTSTHEMAINDOCUMENT}%

magic-line-identifier-for-inclusion



Here starts my document, and it starts with a longer line to see where
the Umbruch is going to take place in this sampel documnet.

Some math $a=b^2$

Eine Überschrift ohne Absatz
\begin{itemize}
\item one
\item two
\item three
...
Nun some\footnote{Fußnote}

Nun ein Text mit einer URL die einen Umbruch enthält und dabei 
die \url{https://www.texthjkuihjioz.de/undnuneinsehrlangertextmiteinemumbruchproblem.html}
...
\begin{minted}[linenos=true, frame=lines %, bgcolor=black!10
]{c}
int axgqo;      
float bcj;      
main() {} 

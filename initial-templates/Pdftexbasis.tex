...
\usepackage[left=0cm,top=0cm,width=15cm,height=500cm,paperwidth=15cm,paperheight=\textheight]{geometry}
...
{\color{red}\rule[-0.1cm]{15cm}{0.01cm}}\par\vspace*{-\parskip}\vspace*{-\baselineskip}%

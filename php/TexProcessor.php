...
// this thing is done in the foreground
  ...
  else {return "Currently we have no image for display. It is possible that the LaTeX source did not produce any output. Migging file is $finalImgPath"; }
 ...
 */
private static function generateTex ( string $rawContent, string $tag, string $mode) : string {
  $VERBOSE       = false;
  $CACHE_PATH    = CACHE_PATH;
  $TEMPLATE_PATH = TEMPLATE_PATH;  $LATEX_FORMAT_PATH = LATEX_FORMAT_PATH;  $PDFLATEX_FORMAT_PATH = PDFLATEX_FORMAT_PATH;
  ...
  switch ($mode) {
    case "pc_latex":           // we use a precompilation made for the latex processor     
      ...
      ASSERT_FILE ("$fmt.fmt");    $template = "%&$fmt\n".PC_LATEX_ADDON[$tag];     break;
